                    ...
                    <Card key={prod.producto._id}>
                        <Card.Body>
                            <Row className="align-items-center">
                                ...
                                <Col xs={9} sm={9} md={5}>
                                    <Link className="linkHotel" style={{ "fontSize": "18px" }} to={`/${normalizeText(prod.producto.categoria.nombre.replace(/\s+/g, "-"))}/${normalizeText(prod.producto.subcategoria.nombre.replace(/\s+/g, "-"))}/${normalizeText(prod.producto.nombre.replace(/\s+/g, "-"))}`}>{prod.producto.nombre}</Link>
